...
ResultSet myResultSet=stmt.executeQuery("SELECT BOOKID,BOOKNAME,PUBLISHER,PRICE FROM BOOK WHERE bookid = '"+10
+"'");
if(myResultSet!=null){
 myResultSet.next();
%>
...
<table border="1" cellspacing="0" width="400" bordercolor="#9AD2F7"
 ...
 <tr>
  <td width="150" height="23">
   <p align="center">
   <span style="font-size:9pt;"><b>책 제 목</b></span></p>
  </td>
  <td width="513">
 ...
 <tr>
  <td width="150" height="23">
   <p align="center">
   <span style="font-size:9pt;"><b>출 판 사</b></span></p>
  <td width="513">
   <p><span style="font-size:9pt;">
 ...
 <tr>
  <td width="150" height="23">
   <p align="center">
   <span style="font-size:9pt;"><b>가 격</b></span></p>
  <td width="513">
   <p><span style="font-size:9pt;">
